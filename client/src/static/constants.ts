...
export function getVisaRequirementType(
  ...
  if (["visa required", "online visa required"].includes(visaRequirement)) {
    return "VISA_REQUIRED";
  }

  if (["evisa"].includes(visaRequirement)) {
    return "EVISA";
  }

  if (["visa on arrival"].includes(visaRequirement)) {
    return "VISA_ON_ARRIVAL";
  }

  if (visaRequirement === "visa not required") {
    return "VISA_NOT_REQUIRED";
  }

  if (visaRequirement === "freedom of movement") {
